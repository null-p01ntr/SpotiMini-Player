...
0- After log in, the browser will redirect to application's page but the url has a code in it
...
0- Right click anywhere to close and toggle different options
